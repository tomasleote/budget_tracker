...
const TransactionCard = ({ 
  ...
  return (
    <div
      className={`card-theme border rounded-lg p-4 transition-all cursor-pointer ${className}`}
    >
      {/* Header */}
      ...
      {/* Actions */}
      {showActions && (
        <div className="flex items-center justify-end space-x-2 mt-4 pt-3 border-t border-theme-primary">
          <Button
            variant="ghost"
            size="sm"
            onClick={(e) => {
      ...
      {/* Status Indicators */}
      <div className="flex items-center justify-between mt-3 pt-2 border-t border-theme-primary">
